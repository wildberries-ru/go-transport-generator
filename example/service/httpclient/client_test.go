...
func Test_client_GetWarehouses(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotPets, err := s.GetWarehouses(tt.args.ctx, tt.args.token)
...
func TestNewClient(t *testing.T) {
	...
	tests := []struct {
		...
		{"test new client", args{hostClient, transportGetWarehouses, transportGetDetails, transportGetDetailsEmbedStruct, transportGetDetailsListEmbedStruct, transportPutDetails, transportGetSomeElseDataUtf8, transportGetFile, opts}, cl},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewClient(tt.args.cli, tt.args.transportGetWarehouses, tt.args.transportGetDetails, tt.args.transportGetDetailsEmbedStruct, tt.args.transportGetDetailsListEmbedStruct, tt.args.transportPutDetails, tt.args.transportGetSomeElseDataUtf8, tt.args.transportGetFile, tt.args.options); !reflect.DeepEqual(got, tt.want) {
